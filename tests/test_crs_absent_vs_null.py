...
class TestIdLessProjjsonAxisOrder:
    ...
    def test_lon_lat_vs_lat_lon_without_ids(self, compare):
        lon_lat = self._idless(CRS84_PROJJSON)
        lat_lon = self._idless(EPSG4326_PROJJSON)
    ...
    def test_different_crs_without_ids_still_differ(self, compare):
        assert compare(self._idless(CRS84_PROJJSON), self._idless(EPSG3857_PROJJSON)) is False
